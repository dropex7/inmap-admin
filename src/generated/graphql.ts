...
export type SubjectLocalizedModel = {
  ...
  content?: Maybe<Array<TemplatedContentLocalizedModel>>;
  images: Array<Scalars["String"]>;
...
export type UploadImageMutation = {
  __typename?: "Mutation";
  uploadImage: { __typename?: "UploadResult"; url: string };
};

export type GetListOfPlacesQueryVariables = Exact<{ [key: string]: never }>;

export type GetListOfPlacesQuery = {
  __typename?: "Query";
  places: Array<{
    __typename?: "PlaceLocalizedModel";
    uuid: string;
...
export type GetPlaceLayersQuery = {
  __typename?: "Query";
  placeLayers: Array<{
    __typename?: "PlaceLayerLocalizedModel";
    uuid: string;
...
export type GetListOfPromosQuery = {
  __typename?: "Query";
  promosOfPlace: Array<{
    __typename?: "PromoLocalizedModel";
    uuid: string;
...
export type GetSubjectsOfPlaceQuery = {
  __typename?: "Query";
  subjectsOfPlace: Array<{
    __typename?: "SubjectLocalizedModel";
    uuid: string;
    name: string;
    layerName: string;
...
export const GetListOfPlacesDocument = {
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetListOfPlaces" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
  ...
  GetListOfPlacesQuery,
  GetListOfPlacesQueryVariables
>;
...
export const GetPlaceLayersDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetPlaceLayers" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "placeUuid" },
          },
          type: {
            kind: "NonNullType",
            type: {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "placeLayers" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "placeUuid" },
...
} as unknown as DocumentNode<GetPlaceLayersQuery, GetPlaceLayersQueryVariables>;
export const GetListOfPromosDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetListOfPromos" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "promosOfPlace" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "placeUuid" },
  ...
  GetListOfPromosQuery,
  GetListOfPromosQueryVariables
>;
export const GetSubjectsOfPlaceDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetSubjectsOfPlace" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "subjectsOfPlace" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "placeUuid" },
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "layerName" } },
                { kind: "Field", name: { kind: "Name", value: "logoUrl" } },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "logoBackgroundColor" },
                },
                {
                  kind: "Field",
  ...
  GetSubjectsOfPlaceQuery,
  GetSubjectsOfPlaceQueryVariables
>;
